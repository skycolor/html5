...
function winORlose() {
	...
	setTimeout(function() {
		...
		if (eat_count <= 20) {
			chat = eat_count + "个包子不过瘾，东营人必须得牛逼！！";
			share = "我在东营人《吃包子大赛》中吃掉了" + eat_count + "个包子，打败了5%的人，求填饱";
			share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
		} else {
			if (eat_count <= 35) {
				chat = "我勒个去，你只吃了" + eat_count + "个包子，摸死了";
				share = "我在蓝色源码《吃包子大赛》中吃掉了" + eat_count + "个包子，打败了15%的人，求填饱";
				share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
			} else {
				if (eat_count <= 50) {
					chat = "唉哟不赖，一口气吃" + eat_count + "个，吃完包子记得喝碗汤呀";
					share = "我在《蓝色源码吃包子大赛》中吃掉了" + eat_count + "个包子，打败了25%的人，求填饱";
					share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
				} else {
					if (eat_count <= 65) {
						chat = "万万没有想到！你吃了" + eat_count + "个包子！放胆吃，吃饱了哥请你喝碗马虎！";
						share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了35%的人，求填饱";
						share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
					} else {
						if (eat_count <= 80) {
							chat = "你吃了" + eat_count + "个包子，看样子你根本停不下来，加油，再来一次更牛的！！";
							share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了45%的人，求填饱";
							share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
						} else {
							if (eat_count <= 95) {
								chat = "你吃了" + eat_count + "个包子，这样的速度，标准的一吃货啊，有潜质 ！";
								share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了55%的人，求填饱";
								share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
							} else {
								if (eat_count <= 110) {
									chat = "你吃了" + eat_count + "个包子，我看你天赋异禀、骨骼惊奇，想来是百年难得一见的吃货奇才！";
									share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了65%的人，求填饱";
									share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
								} else {
									if (eat_count <= 125) {
										chat = "我勒个去，你吃了" + eat_count + "个包子…说点什么好？记得吃药…。";
										share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了75%的人，求填饱";
										share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
									} else {
										if (eat_count <= 140) {
											chat = "你吃了" + eat_count + "个包子，这么快的速度，够神啊";
											share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了85%的人，求填饱";
											share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
										} else {
											chat = "天啊，你竟然吃了" + eat_count + "个包子，简直是神一般的存在，膜拜啦！";
											share = "我在《东营人吃包子大赛》中吃掉了" + eat_count + "个包子，打败了95%的人，求填饱";
											share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png"
										}
									}
								}
...
$(function() {});
var shareUrl = "http://game.id87.com/youxi/games/baozi/index.html",
	shareTitle = "《东营人吃包子大赛》，求填饱！",
	share = "《东营人吃包子大赛》，求填饱！",
	share_imgUrl = "http://game.id87.com/youxi/games/baozi/images/c4.png";
